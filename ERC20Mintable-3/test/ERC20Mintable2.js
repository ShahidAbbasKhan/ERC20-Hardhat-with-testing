...
describe("ERC20Mintable2", function(){
    beforeEach(async function(){
        [owner,add1,add2,...addrs] = await ethers.getSigners();
        const ERC20Mintable2 = await ethers.getContractFactory("ERC20Mintable2");
        Erctoken = await ERC20Mintable2.deploy();
    ...
    describe("MintToken", function(){
        it("should increase supply and address balance", async function(){
          ...
          expect(Erctoken.tokenSupply())===(supplyBeforeMint+2000);
          expect(Erctoken.balanceOf(owner.address))===(ownerBalanceBeforeMint+2000);
          console.log(ownerBalanceBeforeMint+2000);
        })
      })
      describe("BurnToken", function(){
        it("should decrease supply and address balance", async function(){
          ...
          expect(Erctoken.tokenSupply()===(supplyBeforeBurn-2000));
          expect(Erctoken.balanceOf(owner.address)===(supplyBeforeBurn-2000));
        })
      })
})
